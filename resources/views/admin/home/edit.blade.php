  ...
  @endif
    <form method="post" action="{{route('admin.home.update', ['home'=> $home])}}">
        ...
        <div class="form-group">
            ...
            <input type="text" id="title" name="title" class="form-control" value="{{ $home->title }}">
        </div>
        <div class="form-group">
            <label for="resume">Резюме</label>
            <input type="text" id="resume" name="resume" class="form-control" value="{{ $home->resume }}">
        </div>
        <div class="form-group">
            <label for="description">Описание</label>
            <textarea id="description" name="description" class="form-control">{!! $home->description !!}</textarea>
        </div>
        {{-- <div class="form-group">
        ...
        <div class="form-group">
            ...
            <select class="form-control" name="is_visible" id="is_visible">
              ...
              <option @if($home->is_visible == $sectionVisible) selected @endif>{{ $sectionVisible }}</option>
        ...
        <div class="form-group">
          ...
          <select class="form-control" name="status" id="status">
            ...
            <option @if($home->status === $status) selected @endif>{{ $status }}</option>
