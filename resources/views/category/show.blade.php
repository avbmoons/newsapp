...
@section('content')
    ...
    <div>
        <h2>Новости категории {{$category->title}} </h2>
        <a href="{{ route('category.index') }}" class="stretched-link">Назад к списку категорий...</a>
    </div>
...
@endsection    
    ...
    {{-- @foreach ($news as $item)
        <div style="border: 1px solid green">
            ...
            <h3 style="color: violet;">{{ $item['category_title'] }}</h3>
            <h2>{{ $item['title'] }}</h2>
